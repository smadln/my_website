...
document.addEventListener('mousemove', function(e){ 
    ...
    //if(mouseIsDown) {
      ...
      document.getElementById("sandtextureContainer").style.perspectiveOrigin = (mouse.x/myWidth*100).toString() + "% -15%";
      document.getElementById("sandMiddle").style.left = (mouse.x-myWidth-(myWidth*.03)).toString() + "px";
      ...
      if(mouse.y > myHeight/2) {
        ...
        document.getElementById("sandTextureMiddle").style.opacity = (myHeight-mouse.y) / (myHeight/2) - 0.1;
      } else {
        ...
        document.getElementById("sandTextureMiddle").style.opacity = mouse.y / (myHeight/2) - 0.1; 
      }
      ...
      document.getElementById("sandDistance").style.height = (myHeight-mouse.y).toString() + "px";
      document.getElementById("sandTextureContainer").style.height = (myHeight-mouse.y).toString() + "px";
...
function windowResize() {
  ...
  document.getElementById("sandDistance").style.height = myHeight - skyHeight;
